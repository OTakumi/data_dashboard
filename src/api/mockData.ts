...
import type { Order, OrderItem, Product, SalesData } from "../types/sales";
...
export const products: Product[] = [
  ...
  {
    id: "P036",
    name: "ハリオ V60ペーパーフィルター02",
    category: "ドリッパー・フィルター",
    price: 400,
    stock: 200,
    popularity: 96,
  },
